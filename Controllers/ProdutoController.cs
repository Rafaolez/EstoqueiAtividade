    ...
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Index(string pesquisa)
        {
            ...
            else
            {
                var produto =
                    _context.Produto
                    .Where(x => x.NomeProduto.Contains(pesquisa))
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,NomeProduto,PesoProduto,QuantidadeEstoque,Status,TipoProdutoId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,NomeProduto,PesoProduto,QuantidadeEstoque,Status,TipoProdutoId")] Produto produto)
        {
